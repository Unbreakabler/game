import { SvelteComponent, init, safe_not_equal, element, space, text, claim_element, children, detach, claim_space, claim_text, attr, insert, append, listen, set_data, noop, component_subscribe, onMount, binding_callbacks } from '../../node_modules/svelte/internal/index.mjs.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t3 = claim_text(div_nodes, "count: ");
			t4 = claim_text(div_nodes, /*$count*/ ctx[1]);
...
function instance($$self, $$props, $$invalidate) {
	...
	return [canvas, $count, canvas_1_binding];
}
