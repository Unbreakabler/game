import { SvelteComponent, init, safe_not_equal, globals, element, append, create_slot, space, attr, insert, listen, update_slot, transition_in, transition_out, detach, run_all, createEventDispatcher, onDestroy, binding_callbacks } from '../../node_modules/svelte/internal/index.mjs.js';
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "modal-background svelte-1k3utew");
			button.autofocus = true;
			attr(button, "class", "svelte-1k3utew");
			attr(div1, "class", "modal svelte-1k3utew");
