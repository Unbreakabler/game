import { SvelteComponent, init, safe_not_equal, element, append, text, space, claim_element, children, claim_text, detach, claim_space, attr, set_style, insert, set_data, noop } from '../../node_modules/svelte/internal/index.mjs.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t0 = claim_text(span_nodes, /*name*/ ctx[0]);
