export type EnemySizeModifierIds = 'size_0' | 'size_1' | 'size_2' | 'size_3' | 'size_4' | 'size_5'
export type EnemyGroupModifierIds = 'group_0' | 'group_1' | 'group_2' | 'group_3' | 'group_4'
export type EnemyMovementModifierIds = 'movement_0' | 'movement_1' | 'movement_2' | 'movement_3' | 'movement_4' | 'movement_5'
...
export type ModTier = 0 | 1 | 2

export interface WeightedMod {
  id: string,
  weight: integer,
}
...
export const TIER_MODIFIER_WEIGHTS = {
  0: [
...
export const ENEMY_TIER_MODIFIERS_WEIGHTS: ModList = {
