...
export class Job {
  ...
  constructor(id: number, name: string, description: string, base_exp: number, base_income: number, base_exp_rate:number, multiplier: number) {
      this.id = id;
      this.name = name;
  ...
  getTotalExpForLevel(base_exp: number, multiplier: number, current_level: number): number {
