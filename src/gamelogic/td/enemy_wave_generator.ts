...
type EnemySizeModifierIds = 'size_0' | 'size_1' | 'size_2' | 'size_3' | 'size_4' | 'size_5'
type EnemyGroupModifierIds = 'group_0' | 'group_1' | 'group_2' | 'group_3' | 'group_4'
type EnemyMovementModifierIds = 'movement_0' | 'movement_1' | 'movement_2' | 'movement_3' | 'movement_4' | 'movement_5'
