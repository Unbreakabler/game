...
// (43:6) <Tab id={item.id} bind:selected>
function create_default_slot_1(ctx) {
	...
	function switch_instance_selected_binding(value) {
		/*switch_instance_selected_binding*/ ctx[4].call(null, value);
	}
...
function create_each_block(ctx) {
	...
	function tab_selected_binding(value) {
		/*tab_selected_binding*/ ctx[5].call(null, value);
	}
...
function create_fragment(ctx) {
	...
	function tabs_selected_binding(value) {
		/*tabs_selected_binding*/ ctx[6].call(null, value);
	}
