import frag from './dissolve-frag.js';

const GetValue = Phaser.Utils.Objects.GetValue;
const Clamp = Phaser.Math.Clamp;
class DissolvePostFxPipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
    constructor(game) {
        super({
            name: 'DissolvePostFX',
            game: game,
...
(function (ResizeMode) {
    ...
    ResizeMode[ResizeMode["contain"] = 1] = "contain";
    ResizeMode[ResizeMode["cover"] = 2] = "cover";
})(ResizeMode || (ResizeMode = {}));

export default DissolvePostFxPipeline;
//# sourceMappingURL=dissolve-post-fx-pipeline.js.map
